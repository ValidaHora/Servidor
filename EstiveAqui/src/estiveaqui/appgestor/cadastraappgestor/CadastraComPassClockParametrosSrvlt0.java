...
public class CadastraComPassClockParametrosSrvlt0 extends ServletParametros0
{
  private CadastraComPassClockInVO cadastraComPassClockInVO = (CadastraComPassClockInVO)dadosInVo;

  public CadastraComPassClockParametrosSrvlt0(HttpServletRequest request) throws IOException, ServletParametrosException
  {
