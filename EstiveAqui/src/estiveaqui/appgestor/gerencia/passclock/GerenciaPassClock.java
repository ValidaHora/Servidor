...
public class GerenciaPassClock extends RegraNegocioGestor
{
  ...
  public GerenciaPassClockOutVO acao(DadosInVO dadosInVo) throws EstiveAquiException
  {
    ...
    try
    {
      ...
      Versao.validaVersao(gerenciaPassClockInVo, new Versao(1, 0, 0), new Versao(1, 0, 0));
      ...
      if (! gerenciaPassClockInVo.getAcao().equals("CAD"))  //  Se não é um cadastro de PassClock.
