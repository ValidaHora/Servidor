...
//   * @throws ServletParametrosException
//   */
//  private String[] getParametros(String nomeParametro, boolean obrigatorio) throws ServletParametrosException
//  {
//    String[] valores = params.get(nomeParametro);
//    if (valores == null)
//    {
//      if (obrigatorio)
//        throw new ServletParametrosException(PARAMETROOBRIGATORIO, nomeParametro, acao);
//      return null;
//    }
//
//    return valores;
